...
xlsxfile = fullfile('/Volumes/GoogleDrive/My Drive/Python/large files/2.0x Perturbed Mesh','fourier_parameters.xlsx');
...
saveas(fig,fullfile('/Volumes/GoogleDrive/My Drive/Python/large files/2.0x Perturbed Mesh', '2.0X Amplitude Coefficients.png'))
